...
class DDPM(pl.LightningModule):
    ...
    def init_from_ckpt(self, path, ignore_keys=list(), only_model=False): #changed
...
class LatentDiffusion(DDPM):
    ...
    def __init__(self,
        ...
        if ckpt_path is not None:
            ...
            if self.use_ema and not load_ema: # changed
                self.model_ema = LitEma(self.model)
                print(f"Keeping EMAs of {len(list(self.model_ema.buffers()))}.")
    ...
    def get_input(self, batch, k, return_first_stage_outputs=False, force_c_encode=False,
                  cond_key=None, return_original_cond=False, bs=None, uncond=0.05): # changed
    ...
    def log_images(self, batch, N=4, n_row=4, sample=True, ddim_steps=200, ddim_eta=1., return_keys=None,
                   ...
                   plot_diffusion_rows=False, **kwargs): #changed
